...
export default function Home() {
  return (
    <div className="relative flex h-screen flex-col items-center justify-center bg-cyan-950 text-yellow-300 text-opacity-80">
      <h1 className="text-center text-5xl font-bold">Donut Component</h1>
      <p className="mt-4 text-center text-xl text-yellow-300 text-opacity-80">
      ...
      <div className="absolute bottom-4 left-10 text-xl font-semibold text-yellow-300 text-opacity-80 hover:font-bold sm:flex sm:flex-col sm:items-start sm:justify-start">
        <div>
